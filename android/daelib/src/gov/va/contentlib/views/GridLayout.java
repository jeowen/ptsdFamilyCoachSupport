...
*/	
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		float childPlusSpacingWidth = widthMinusMargin / columns;
		float childPlusSpacingHeight = heightMinusMargin / rows;
		float childWidth = (widthMinusMargin - (cellSpacingX * (columns-1))) / columns;
		float childHeight = (heightMinusMargin - (cellSpacingY * (rows-1))) / rows;
