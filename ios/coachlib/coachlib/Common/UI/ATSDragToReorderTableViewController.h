...
@interface ATSDragToReorderTableViewController : ContentListViewController <UIGestureRecognizerDelegate, ATSDragToReorderTableViewControllerDraggableIndicators>  {
@protected
...
@private
	...
	NSIndexPath *indexPathOfMovingCell;
