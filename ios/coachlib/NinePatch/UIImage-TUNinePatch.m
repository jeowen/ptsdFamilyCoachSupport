...
-(NSRangeF)blackPixelRangeInUpperStrip {
	NSRangeF blackPixelRangeInUpperStrip = TUNotFoundRange;
...
-(NSRangeF)blackPixelRangeInLowerStrip {
	NSRangeF blackPixelRangeInLowerStrip = TUNotFoundRange;
...
-(NSRangeF)blackPixelRangeInLeftStrip {
	NSRangeF blackPixelRangeInLeftStrip = TUNotFoundRange;
...
-(NSRangeF)blackPixelRangeInRightStrip {
	NSRangeF blackPixelRangeInRightStrip = TUNotFoundRange;
...
-(NSRangeF)blackPixelRangeAsVerticalStrip {
	NPAssert([self size].width == 1.0f, @"This method assumes the image has width == 1.0f");
	NSRangeF blackPixelRangeAsVerticalStrip = TUNotFoundRange;
...
-(NSRangeF)blackPixelRangeAsHorizontalStrip {
	NPAssert([self size].height == 1.0f, @"This method assumes the image has height == 1.0f");
	NSRangeF blackPixelRangeAsHorizontalStrip = TUNotFoundRange;
	NSUInteger firstBlackPixel = NSNotFound;
	NSUInteger lastBlackPixel = NSNotFound;
